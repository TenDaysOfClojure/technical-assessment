(ns technical-assessment.domain.facebook-user-test
...
(deftest facebook-user-test
  ...
  (testing "user-id"
    (is (= "111111222223333" (facebook-user/user-id sample-facebook-user))))
  ...
  (testing "profile-picture-url"
    (is (= "https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=111111222223333&height=2048&width=2048&ext=1"
           (facebook-user/profile-picture-url sample-facebook-user))))


  (testing "first-name"
    (is (= "Joe" (facebook-user/first-name sample-facebook-user))))


  (testing "last-name"
    (is (= "Soap" (facebook-user/last-name sample-facebook-user))))



  (testing "full-name"
    (is (= "Joe Soap" (facebook-user/full-name sample-facebook-user))))


  (testing "email-address"
    (is (= "joesoap@mailinator.com" (facebook-user/email-address sample-facebook-user)))))
